...
class CChan:
    ...
    def get_load_stock_iter(self, stockapi_cls, lv):
        ...
        if self.data_src == DATA_SRC.DATAFRAME:
            stockapi_instance.set_dataframe(self.dataframe)
    ...
    def GetStockAPI(self):
        ...
        if self.data_src == DATA_SRC.BAO_STOCK:
            ...
            from chan.DataAPI.dataframeAPI import DataFrame_API
            ...
            if self.klu_cache[lv_idx]:
                ...
                try:
                    ...
                    if not kline_unit.time > self.klu_last_t[lv_idx]:
                        ...
                        print(f"kline time err, cur={kline_unit.time}, last={self.klu_last_t[lv_idx]}", ErrCode.KL_NOT_MONOTONOUS)
